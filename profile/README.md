...
- __AI for science__ :: 
The bootcamp content applies AI to scientific research and engineering—from digital biology and molecular design to physics-informed modeling and large-scale scientific computing.

| Lab      | Description |
| ----------- | ----------- |
| [AI-Powered Drug Discovery Bootcamp](https://github.com/openhackathons-org/AI-Powered-Drug-Discovery-Bootcamp) | The AI-Powered Drug Discovery Bootcamp provides attendees with an overview of the BioNeMo platform for digital biology, explores MolMIM (Molecular Masked Image Modeling), an AI model for small molecule drug discovery that can generate novel, valid molecules with specific properties, and highlights DiffDock, an AI model that predicts the three-dimensional structure of a protein-ligand complex, a crucial step in the drug discovery process.<br><br>Attendees are guided through comprehensive tutorials and participate in an exciting hands-on challenge, generating and optimizing novel molecular structures with a focus on their potential as therapeutic agents, to gain valuable practical experience. |
