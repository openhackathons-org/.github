...
| Lab      | Description |
| ----------- | ----------- |
| [Profiling AI Software Bootcamp](https://github.com/openhackathons-org/Profiling-AI-Software-Bootcamp)   | Learn how to optimize a Deep Neural Network (DNN) training using profiling tools   |
